...
// props passed as a single object from the parent: { data, onChange, setResumeData }
const ProfessionalSummaryForm = ({data, onChange, setResumeData}) => {
  ...
  setResumeData(prev => ({...prev, professional_summary: response.data.enhanceContent || response.data.enhancedContent}))
    } catch (error) {
  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        <div>
            <h3 className='flex items-center gap-2 text-lg font-semibold text-gray-900'>Professional Sammary</h3>
